...
# still wires Print Screen via gsettings (GNOME-only). Once the WM choice is
# locked in, add the relevant package group to nonServePackages and either:
